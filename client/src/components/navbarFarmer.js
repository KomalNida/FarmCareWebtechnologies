            ...
            <nav className="navbar navbar-expand navbar-dark " style={{backgroundColor: "#0d4f02", paddingLeft: 20, height:70}} >
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li className="nav-item "  >
                        <NavLink className="nav-link" to="/FarmerDashboard"> Home </NavLink>
                    </li>
                    <li className="nav-item" style={{ marginLeft: 10}}>
                        <NavLink className="nav-link" to="/AnimalMain"> Animal </NavLink>
                    </li>
                    <li className="nav-item" style={{ marginLeft: 10}}>
                        <NavLink className="nav-link" to="/ViewAnimalEvents"> Event </NavLink>
                    </li>
                    <li className="nav-item" style={{ marginLeft: 10}}>
                        <NavLink className="nav-link" to="/MilkRecordMain"> Milk  </NavLink>
                    </li>
                    <li className="nav-item" style={{ marginLeft: 10}}>
                        <NavLink className="nav-link" to="/BarChart"> Reports </NavLink> 
                    </li>
                    </ul>
