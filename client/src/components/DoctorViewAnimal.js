        ...
        if (
          ...
          if (role === "Doctor") {
            return (
                <>
            <NavbarDoctor />   
            <NavLink to="/DoctorAnimalMain" > <ion-icon name="arrow-back-outline" size='large' style={{margin:'2%' , color:'black'}}></ion-icon></NavLink>
            <h3  style={{marginTop:0, textAlign:'center', marginBottom:30}}>Animal Profile </h3>
           
             
             <div className='shadow p-3 ' style={{ display: 'flex' ,flexDirection: 'column', 
             marginLeft:'25%', marginRight:'100px', width:"50%"
            , marginBottom:'90px', marginTop:'30px' }}>
            
                        <Table  hover='true' >

                            <div className='row'>
                                <div className='cold-md-6' style={{marginLeft:"30%", marginTop:20}}>
                                ...
                                <div className='cold-md-6' style={{marginLeft:"5%", marginTop:20}}>
...
export default DoctorViewAnimal;